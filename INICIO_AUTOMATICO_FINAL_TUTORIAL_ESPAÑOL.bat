@echo off
echo ===========================================
echo L2 HERMANOS - INICIO AUTOMÁTICO FINAL DEL TUTORIAL EN ESPAÑOL
echo ===========================================
echo.
echo 🚀 Iniciando tutorial en español automáticamente...
echo.
...
echo.
echo ===========================================
echo L2 HERMANOS - TUTORIAL EN ESPAÑOL INICIADO
echo ===========================================
echo.
...
echo.
echo ¡¡¡ TUTORIAL EN ESPAÑOL INICIADO AUTOMÁTICAMENTE !!!
echo.
echo 📋 Próximos pasos:
