@echo off
echo ===========================================
echo L2 HERMANOS - ACTUALIZACIÓN FINAL DEL TUTORIAL EN ESPAÑOL
echo ===========================================
echo.
echo 🔄 Actualización final del tutorial en español...
echo.

echo ===========================================
echo ACTUALIZACIÓN FINAL DE ARCHIVOS
echo ===========================================
echo.

REM Actualizar archivos del tutorial
if exist "gameserver\data\scripts\events\EpicTutorialSpanish.py" (
    echo ✅ EpicTutorialSpanish.py - ACTUALIZADO
    echo    Tamaño: 
...
if exist "gameserver\data\scripts\events\EpicTutorialAutoStart.py" (
    echo ✅ EpicTutorialAutoStart.py - ACTUALIZADO
    echo    Tamaño: 
...
if exist "gameserver\data\scripts\ai\npc\EpicTutorialNPC.py" (
    echo ✅ EpicTutorialNPC.py - ACTUALIZADO
    echo    Tamaño: 
...
if exist "gameserver\data\html\tutorial_spanish.htm" (
    echo ✅ tutorial_spanish.htm - ACTUALIZADO
    echo    Tamaño: 
...
if exist "gameserver\data\html\tutorial_menu.htm" (
    echo ✅ tutorial_menu.htm - ACTUALIZADO
    echo    Tamaño: 
...
if exist "gameserver\config\head\tutorial_spanish.properties" (
    echo ✅ tutorial_spanish.properties - ACTUALIZADO
    echo    Tamaño: 
...
echo.
echo ===========================================
echo ACTUALIZACIÓN FINAL COMPLETADA
echo ===========================================
echo.
echo 🔄 Actualización final realizada:
echo ✅ Archivos del tutorial actualizados
...
echo.
echo 🌟 L2 HERMANOS - ACTUALIZACIÓN FINAL COMPLETADA
...
echo.
echo ¡¡¡ ACTUALIZACIÓN FINAL DEL TUTORIAL EN ESPAÑOL COMPLETADA !!!
echo.
echo 📋 Información de la actualización final:
echo 📅 Fecha: %date%
echo ⏰ Hora: %time%
echo 📁 Ubicación: %CD%
echo 🖥️ Sistema: %OS%
